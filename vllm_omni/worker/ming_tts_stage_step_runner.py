...
class MingTTSStageStepRunner:
    ...
    def supports_batch(self, *, runner: Any, runtime_infos: list[dict], is_graph_capturing: bool) -> bool:
        ...
        if stage != "ming_flash_omni_tts" and arch != "MingFlashOmniTalkerForConditionalGeneration":
    ...
    def prepare_step(self, *, request_ids: list[str], runtime_infos: list[dict], inputs_embeds: torch.Tensor) -> MingTTSPreparedStep:
