...
class OmniRunnerDataPlane(OmniConnectorModelRunnerMixin):
    ...
    _recv_readiness: ShmReadiness | None
    _native_output_worker: threading.Thread | None
    _local_stage_payload_cache: dict[str, Any]
        ...
        while not self._stop_event.is_set():
            with self._lock:
                ...
                keys = {
                    ...
                    if not self._payload_is_consumable(self._local_stage_payload_cache.get(req_id))
