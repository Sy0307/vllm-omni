...
_PUBLIC_OMNI = (
    ...
    "VLLM_OMNI_CHUNK_ENGINE_WAKEUP",
    "VLLM_OMNI_DRAIN_READY_GENERATION",
    "VLLM_OMNI_ASYNC_NATIVE_OUTPUT",
    "VLLM_OMNI_GENERATION_COMPLETION_EVENTS",
    "VLLM_OMNI_ASYNC_METADATA",
    "VLLM_OMNI_CHUNK_RECV_EVENTS",
    "VLLM_OMNI_GENERATION_PAYLOAD_NATIVE",
    "VLLM_OMNI_BATCH_STATE_COPIES",
    "VLLM_OMNI_SHM_COHORT_NAMESPACE",
    "VLLM_OMNI_CONTROL_FASTPATH",
