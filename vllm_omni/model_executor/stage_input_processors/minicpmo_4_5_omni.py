...
def _native_duplex_segment_output_ids(
    ...
    *,
    ...
    if unit_seq is not None and state.get("unit_seq") != unit_seq:
...
def _build_native_duplex_turn_end_input(
    *,
    ...
    set_tts_handoff(cast(dict[str, object], model_intermediate_buffer), [], [])
    ...
    for llm_output in llm_outputs:
        ...
        if _has_native_duplex_prompt_metadata(mm_output):
            ...
            llm_output_ids, thinker_text, native_turn_start = _native_duplex_segment_output_ids(
                ...
                unit_seq=special_token_ids.get("gander_append_seq"),
            )
