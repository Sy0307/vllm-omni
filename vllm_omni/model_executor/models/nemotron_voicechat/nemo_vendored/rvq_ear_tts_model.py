...
# Vendored from NVIDIA-NeMo/Speech (branch nemotron-labs-voicechat) nemo/collections/speechlm2/modules/rvq_ear_tts_model.py; training-only code removed.
...
class NeMoSubwordFlagEmbedding(nn.Module):
    ...
    def __init__(self, model_name: str, d_model: int):
        ...
        from .tokenizer import AutoTokenizer as NeMoAutoTokenizer
