...
class Qwen3Omni_VisionTransformer(_Qwen3Omni_VisionTransformer):
    ...
    def forward(
        ...
        sequence_lengths = MMEncoderAttention.maybe_compute_seq_lens(self.attn_backend, cu_seqlens, self.device)
...
class Qwen3OmniMoeThinkerMultiModalProcessor(
    ...
    def _derive_audio_from_video_placeholders(
        ...
        Args:
            ...
            mm_prompt_updates: Prompt updates used to validate extracted audio.
            video_use_audio_in_video: Per-video flags indicating whether audio
                was extracted from that video.
        """
