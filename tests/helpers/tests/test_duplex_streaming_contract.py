...
def test_native_interrupt_requires_model_action_cancel_and_correct_followup(
    ...
    events: list[dict[str, object]] = [
        ...
        {"type": "response.audio.delta", "response_id": "a", "delta": "AAAA"},
        {"type": "response.audio_transcript.delta", "response_id": "a", "delta": "长回答"},
        ...
        {"type": "response.audio.delta", "response_id": "b", "delta": "AAAA"},
        {"type": "response.audio_transcript.delta", "response_id": "b", "delta": answer},
